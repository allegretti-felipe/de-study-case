"""
This module contains a specific implementation of Scrapy's CrawlSpider for the bolt.com domain.
...
class BoltSpider(CrawlSpider):
    """
    BoltSpider is a Scrapy spider for crawling the bolt.com website.
    ...
    name = "Bolt"
    allowed_domains = ["bolt.com"]
    start_urls = ["https://www.bolt.com"]
